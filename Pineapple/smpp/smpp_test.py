...
class Test_SMP(unittest.TestCase):
    ...
    def test_smpp(self):
        ...
        areas, max_p, het = smpp(df, w, d_attribute_col_name, s_attribute_col_name, threshold, maxItr, convSA, cores, nRows, nColumns)
    ...
    def test_smpp_df_format(self):
        ...
        with self.assertRaises(Exception):
            areas, max_p, het = smpp(None, w, d_attribute_col_name, s_attribute_col_name, threshold, maxItr, convSA, cores, nRows, nColumns)
    ...
    def test_smpp_w_format(self):
        ...
        nColumns = 1
        with self.assertRaises(Exception):
            areas, max_p, het = smpp(df, None, d_attribute_col_name, s_attribute_col_name, threshold, maxItr, convSA, cores, nRows, nColumns)
