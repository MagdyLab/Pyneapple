import sys
from pyneapple.regionalization.pruc import pruc
import geopandas
import libpysal
import unittest
...
class TestPruc(unittest.TestCase):
    ...
    def test_pruc_basic(self):
        ...
        threshold = 3000000
        p = 10
        het , label = pruc(mexico, mexico_w,  sim_attr , ext_attr , threshold , p)
        print(type(het))
        print(type(label))
        print(mexico.shape)
        print(type(mexico.shape))
    ...
    def test_pruc_gdf_format(self):
        ...
        with self.assertRaises(Exception) as context:
            pruc(None , mexico_w,  sim_attr , ext_attr , threshold , p)
    ...
    def test_pruc_w_format(self):
        ...
        p = 10
        with self.assertRaises(Exception) as context:
            pruc(mexico, None,  sim_attr , ext_attr , threshold , p)
    ...
    def test_pruc_sim_attr_not_exist(self):
        ...
        p = 10
        with self.assertRaises(Exception) as context:
            pruc(mexico, mexico_w,  "any_input" , ext_attr , threshold , p)
    ...
    def test_pruc_sim_attr_not_numerical(self):
        ...
        p = 10
        with self.assertRaises(Exception) as context:
            pruc(mexico, mexico_w,  "CODE" , ext_attr , threshold , p)
    ...
    def test_pruc_ext_attr_not_exist(self):
        ...
        p = 10
        with self.assertRaises(Exception) as context:
            pruc(mexico, mexico_w,  sim_attr , "any_input" , threshold , p)
    ...
    def test_pruc_ext_attr_not_numerical(self):
        ...
        p = 10
        with self.assertRaises(Exception) as context:
            pruc(mexico, mexico_w, sim_attr , "CODE" , threshold , p)
    ...
    def test_pruc_invalid_p(self):
        ...
        threshold = 3000000
        with self.assertRaises(Exception) as context:
            pruc(mexico, mexico_w,  sim_attr , ext_attr , threshold , "1.2")
    ...
    def test_pruc_invalid_threshold(self):
        ...
        p = 10
        with self.assertRaises(Exception) as context:
            pruc(mexico, mexico_w,  sim_attr , ext_attr , "-34000" , p)
