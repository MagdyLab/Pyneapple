...
def smpgraph(df, w, attrs_name, threshold_name, threshold, maxItr = 100, lengthTabu = 100, t = 1, convSA = 90, alpha = 0.9, nRows = 2, nColumns = 2, cores = 4, random = 0):
    ...
    SMPI = jpype.JClass("edu.ucr.cs.pineapple.regionalization.SMPPGRAPHPythonInterface")()
