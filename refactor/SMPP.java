...
public class SMPP{
    ...
    public static void readFiles(int dataSet,
        ...
        switch (dataSet) {
            ...
            case 14:
                dbfFile = "C:/Users/50476/Documents/GitHub/SMP Code/Datasets/LACity/LACity.dbf";
                shpFile = "C:/Users/50476/Documents/GitHub/SMP Code/Datasets/LACity/LACity.shp";
        }
        ...
        while (dbfReader.hasNext()) {
            ...
            if (dataSet == 1 || dataSet == 2) {
                ...
                populationField = Long.valueOf((Long) fields[63]);
                householdField = Long.valueOf((Long) fields[64]);
            }
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        //MULTIPOLYGON (((-118.63347321416312 34.26952689162438, -118.63348521488805 34.26963089093854, -118.63325421393336 34.26969289165352, -118.63347321416312 34.26952689162438)))

        coorList.add(new Coordinate(-118.63347321416312, 34.26952689162438));
        coorList.add(new Coordinate(-118.63348521488805,34.26963089093854));
        coorList.add(new Coordinate(-118.63325421393336,34.26969289165352));
        coorList.add(new Coordinate(-118.63347321416312, 34.26952689162438));
        GeometryFactory gFactory = new GeometryFactory();

        Coordinate[] coorArray = new Coordinate[coorList.size()];
        coorArray = coorList.toArray(coorArray);
        Polygon gPolygon = gFactory.createPolygon(coorArray);
        ArrayList<Polygon> polyList = new ArrayList<>();
        polyList.add(gPolygon);
        Geometry g = gFactory.buildGeometry(polyList);
